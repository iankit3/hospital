...
s4.setMaxInactiveInterval(600);
if(s4.getAttribute("username")==null || s4==null)
{
	request.getRequestDispatcher("pathology.jsp").forward(request,response);
}
%>
...
<div class="wrapper col2">
  <div id="topbar">
    ...
    <div id="search">
      <a href="Logout/logout2.jsp"><input type="button" name="logout" value="Logout"/></a>
    </div>
    <br class="clear" />
  </div>
</div>
