...
<div class="wrapper col3">
  <div id="breadcrumb">
    <ul>
      ...
      <li>&#187;</li>
      <li><a href="#">Pathologist Registration</a></li>
    </ul>
  </div>
</div>
<div class="wrapper col3">
  <div id="intro">
  <div class="fl_left1">
  <h1>Pathologist Registration</h1>
<p>All the details of Pathologist are successfully inserted.</p>
<p>The Pathologist is registered with an id: <%=id%></p>
</div>
