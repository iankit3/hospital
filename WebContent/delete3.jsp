...
<div class="wrapper col3">
  ...
  <p>Here admin can Delete receptionist details by just selecting his/her Id from the select box which contain id of every receptionist in database and click the delete button. And all detail related to that receptionist are deleted.</p>
